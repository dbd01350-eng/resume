  ...
  const projects = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: '영상기획서', url: '#' },
        { label: '스토리보드', url: 'https://drive.google.com/file/d/1DW5wDzza5ict6v7N9Sv253TQWXQzohEg/view?usp=sharing' },
      ],
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-[60px] items-start justify-between">
        ...
        <div className="w-full lg:w-[400px] flex-shrink-0 lg:sticky lg:top-[160px] space-y-6 sm:space-y-[40px]">
          <div className="space-y-3 sm:space-y-[20px]">
            ...
            <p className="font-['Pretendard'] font-normal text-[15px] sm:text-[18px] leading-[1.6em] text-[#585858] max-w-sm whitespace-pre-line">
          ...
          <div>
            <a 
              href="#works" 
              className="inline-flex items-center space-x-3 px-5 py-2.5 sm:px-[26px] sm:py-[12px] rounded-[200px] border border-[#161616] font-['Funnel_Display'] font-semibold text-[16px] sm:text-[18px] text-[#161616] hover:bg-[#161616] hover:text-white transition-colors"
            >
              <span>Works</span>
              <span>→</span>
            </a>
            ...
            <div key={project.id} className="space-y-4 sm:space-y-[24px]">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-[10px]">
                {project.tags.map((tag, idx) => (
                  <span 
                    key={idx} 
                    className="px-3 py-1 sm:px-[16px] sm:py-[6px] rounded-[12px] sm:rounded-[16px] bg-white border border-[#E5E5E5] font-['Pretendard'] text-[12px] sm:text-[14px] text-[#585858]"
                  >
                    {tag}
                  </span>
                ))}
                ...
                <div className="flex flex-wrap gap-3 sm:gap-[16px]">
                  {project.links.map((link, idx) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center space-x-1 font-['Funnel_Display'] font-medium text-[14px] sm:text-[16px] text-[#161616] underline hover:text-[#9F8BE7] transition-colors"
                    >
