  ...
  return (
    <section id="contact" className="py-[40px] md:py-[80px] px-4 sm:px-10 lg:px-12 xl:px-[80px] max-w-[1920px] mx-auto">
      ...
      <div className="bg-[#161616] dark:bg-[#FAF7F6] text-white dark:text-[#161616] rounded-[32px] sm:rounded-[60px] lg:rounded-[200px] p-6 sm:p-10 lg:p-12 xl:p-[80px] relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10 xl:gap-[60px] min-h-[480px] md:min-h-[540px] lg:min-h-[580px] xl:min-h-[640px]"> {/* token-exempt: cta banner container layout */}
        ...
        <img 
          src="/assets/projects/figma_58d0ae89.png" 
          alt="" 
          ...
          <div className="flex flex-col justify-center gap-[6px] sm:gap-[10px]">
            ...
            <div className="flex flex-nowrap items-center gap-1.5 min-[380px]:gap-2 sm:gap-[10px] whitespace-nowrap">
              <div className="w-[26px] h-[26px] min-[380px]:w-[34px] min-[380px]:h-[34px] sm:w-[46px] sm:h-[46px] md:w-[54px] md:h-[54px] lg:w-[60px] lg:h-[60px] xl:w-[76px] xl:h-[76px] 2xl:w-[80px] 2xl:h-[80px] flex items-center justify-center flex-shrink-0">
                <img 
                  src="/assets/projects/figma_d4c367a2.png" 
                  alt="" 
                  className="w-full h-full object-contain" 
                  onError={(e) => e.target.style.display = 'none'}
                />
              </div>
              <h2 className="font-['Funnel_Display'] font-semibold text-[clamp(20px,5vw,24px)] min-[380px]:text-[28px] sm:text-[36px] md:text-[48px] lg:text-[60px] xl:text-[88px] 2xl:text-[120px] leading-[1.1] text-white dark:text-[#161616] opacity-90 tracking-tight whitespace-nowrap flex-shrink-0">
                Let's talk about
              </h2>
            </div>
        ...
        <div className="relative w-full max-w-[340px] sm:max-w-[420px] md:max-w-[480px] lg:max-w-none lg:w-1/2 h-[220px] sm:h-[270px] md:h-[340px] lg:h-[420px] xl:h-[500px] 2xl:h-[540px] flex items-center justify-center z-10 mx-auto lg:mx-0 flex-shrink-0">
          {/* Large Helmet Image */}
          <img 
            src="/assets/projects/figma_ffd7f43c.png" 
            alt="CTA Image Large" 
          ...
          <img 
            src="/assets/projects/figma_9b50fe7b.png" 
            alt="CTA Image Small" 
