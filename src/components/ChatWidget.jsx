...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-4 sm:left-6 z-50 flex flex-col items-center gap-1.5 print:hidden"> {/* token-exempt: fixed layout positioning */}
        <button
        ...
        >
          <img
            src="/assets/hero/glassheart.png"
            alt="Chatbot Logo"
